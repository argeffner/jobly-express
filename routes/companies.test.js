  ...
  test("works for anon", async function () {
    ...
    expect(resp.body).toEqual({
      company: {
        ...
        logoUrl: "http://c1.img",
        jobs: [
          {id: testJobId[0], title: 'job1', salary: 100, equity: '0.1'},
          {id: testJobId[1], title: 'job2', salary: 200, equity: '0.2'},
          {id: testJobId[2], title: 'job3', salary: 300, equity: '0'},
          {id: testJobId[3], title: 'job4', salary: null, equity: null},
        ],
      },
    });
  });
