...
describe("findAll", function () {
  ...
  test("if min > max", async function () {
    try {
...
describe("get", function () {
  test("works", async function () {
    ...
    expect(company).toEqual({
      ...
      logoUrl: "http://c1.img",
      jobs: [
        {id: testJobId[0], title: 'job1', salary: 200, equity: '0.1' },
        {id: testJobId[1], title: 'job2', salary: 100, equity: '0.3' },
        {id: testJobId[2], title: 'job3', salary: null, equity: null },
        {id: testJobId[3], title: 'job4', salary: 300, equity: '0.2' },
      ]
    });
  });
